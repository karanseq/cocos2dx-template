...
LevelCompletePopup::LevelCompletePopup(GameWorld* game_world, int score)
{
	game_world_ = game_world;
	game_world_->is_popup_active_ = true;
	...
	label = CCLabelTTF::create(buf, "Arial", 44.0f);
...
LevelCompletePopup* LevelCompletePopup::create(GameWorld* game_world, int score)
{
	LevelCompletePopup* level_complete_popup = new LevelCompletePopup(game_world, score);
